...
class Zefoy:
    def __init__(self):
        ...
        url1=input("\033[1;33m HÃY ĐIỀN LINK VIEW BẠN MUỐN BUFF VÀO ĐÂY :  ")
    ...
    def get_captcha(self):
        ...
        try:
            ...
            print(f"\033[1;33m KHÔNG THỂ GIẢI CAPCHA: {e}")
            time.sleep(2)
            self.get_captcha()
    ...
    def send_captcha(self, new_session = False):
        if new_session: 
            ...
            time.sleep(2)
        if self.get_captcha(): 
            print('\033[1;35mĐANG KẾT NÓI TỚI PHIÊN BẢN')
            return (True, 'KẾT NỐI PHIÊN BẢN THÀNH CÔNG')
    ...
    def get_status_services(self):
        ...
        for x in re.findall(r'<hclass="card-title">.+</h5>\n.+<button .+', request): 
    ...
    def get_table(self, i = 1):
        ...
        while True:
            if len(self.get_status_services()[0])>1:
                ...
                print('KHÔNG THỂ NHẬN NHIỆM VỤ, ĐANG THỬ LẠI...');self.send_captcha();time.sleep(2)
        for service in self.services:
            ...
            i += 1
        table.title = f"{Fore.WHITE} Update By Le Minh Duc: {len([x for x in self.services_status if self.services_status[x]])}{Fore.RESET}"
        print(table)

    def find_video(self):
        if self.service is None: return (False, "BẠN CHƯA LỰA CHỌN DỊCH VỤ, HÃY CHỌN DỊCH VỤ")
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zefoy:
                    t-=1
                    print('\033[36m[Le Minh Duc]=>Please what: \033[1;32m{0}\033[31m '.format(t)+'second\033[1;32m',end='\r')
                    time.sleep(1)
                continue
            elif 'BẠN ĐANG LỰA CHỌN QUÁ NHANH, HÃY CHẬM LẠI' in self.video_info:
                time.sleep(3)
            else:
    ...
    def use_service(self):
        ...
        if 'Session expired. Please re-login' in res:
            ...
            self.send_captcha()
            return ""
        elif 'BẠN ĐANG LỰA CHỌN QUÁ NHANH, HÃY CHẬM LẠI' in res:
            time.sleep(3)
    ...
    def select_service(self):
        while True:
            ...
            tim = "\033[1;35m"
            self.get_table()
            print(f"{xanh_la} HÃY CHỌN SỐ MÀ BẠN MUỐN \033[1;37m:", end=' ')
            service_id = input()
    ...
    def run(self):
        ...
        while True:
            ...
            tim = "\033[1;35m"
            try:
                if 'HIỆN TẠI DỊCH VỤ ĐANG BẢO TRÌ, HÃY THỬ LẠI SAU.' in str(self.use_service()):
                    print(f'{do}[\033[1;33mDỊCH VỤ ĐANG BẢO TRÌ, HÃY THỬ LẠI SAU')
                    time.sleep(5)
            except Exception as e:
                print(f'\033[1;31mLỖI NGHIÊM TRỌNG | THỬ LẠI SAU | {e}')
                time.sleep(10)
